...
if __name__ == "__main__":
    ...
    mazes = [
        ...
        ["XXXXXXXXX",
         ...
         # Mirrored easy difficulty: Score > -20
        ["XXXXXXX",
         "X...PGX",
         "X.P.P.X",
         "X.....X",
    ...
    env = Environment(mazes[3], tick_length = 1, verbose = True)
    env.start_mission()
