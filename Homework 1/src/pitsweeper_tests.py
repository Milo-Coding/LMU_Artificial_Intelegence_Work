...
class PitsweeperTests(unittest.TestCase):
    ...
    @pytest.mark.timeout(EASY_TIMEOUT)
    def test_pitsweeper_easy4(self) -> None:
        maze = ["XXXXXX", # 0
                "X...GX", # 1
                "X.PP.X", # 2
                "X....X", # 3
    ...
    @pytest.mark.timeout(MED_TIMEOUT)
    def test_pitsweeper_med3(self) -> None:
        maze = ["XXXXXXXXX",
                "X..PG...X",
                "X..P.P..X",
                "X..P.P..X",
    ...
    @pytest.mark.timeout(MED_TIMEOUT)
    def test_pitsweeper_med4(self) -> None:
        maze = ["XXXXXXXXX",
                "X.G.P...X",
                "X.......X",
                "X.P.P.P.X",
    ...
    @pytest.mark.timeout(MED_TIMEOUT)
    def test_pitsweeper_med5(self) -> None:
        maze = ["XXXXXXXXX",
                "X.P.....X",
                "X..G....X",
                "X..PPP..X",
    ...
    @pytest.mark.timeout(MED_TIMEOUT)
    def test_pitsweeper_med6(self) -> None:
        maze = ["XXXXXXXXX",
                "X..P.PG.X",
                "X.......X",
                "X..P..P.X",
    ...
    @pytest.mark.timeout(MED_TIMEOUT)
    def test_pitsweeper_med7(self) -> None:
        maze = ["XXXXXXXXX",
                "X....G..X",
                "X..PPP..X",
                "X.......X",
    ...
    def test_pitsweeper_hard3(self) -> None:
        ...
        env = Environment(maze, tick_length=TICK, verbose=VERBOSE)
        score = env.start_mission()
        self.score_maze(-40, score, med_scores)

    @pytest.mark.timeout(HARD_TIMEOUT)
    def test_pitsweeper_hard4(self) -> None:
        maze = ["XXXXXXXXX",
                "X...G...X",
                "X.P.PP..X",
                "X.P.....X",
    ...
    @pytest.mark.timeout(HARD_TIMEOUT)
    def test_pitsweeper_hard5(self) -> None:
        maze = ["XXXXXXXXX",
                "X.....GX",
                "X.PP.P.X",
                "X..P.P.X",
    ...
    @pytest.mark.timeout(HARD_TIMEOUT)
    def test_pitsweeper_hard6(self) -> None:
        maze = ["XXXXXXXXX",
                "X..PP..GX",
                "X.......X",
                "X...PP..X",
    ...
    @pytest.mark.timeout(HARD_TIMEOUT)
    def test_pitsweeper_hard7(self) -> None:
        maze = ["XXXXXXXXX",
                "X...P..GX",
                "X.P.P...X",
                "X....P..X",
    ...
    @pytest.mark.timeout(HARD_TIMEOUT)
    def test_pitsweeper_hard8(self) -> None:
        maze = ["XXXXXXXXX",
                "X....PG.X",
                "X.PP....X",
                "X...P.P.X",
    ...
    @pytest.mark.timeout(HARD_TIMEOUT)
    def test_pitsweeper_hard9(self) -> None:
        maze = ["XXXXXXXXX",
                "X...PP.GX",
                "X.P.....X",
                "X..PP.P.X",
